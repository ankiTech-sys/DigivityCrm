...
use App\Helpers\NewEloquentBuilder;
use Carbon\Carbon;
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (in_array('branches_id', $model->fillable))
                $model->branches_id = auth()->user()->branches_id;

            if (in_array('academic_id', $model->fillable))
                $model->academic_id = auth()->user()->academic_id;

            if (in_array('financial_id', $model->fillable))
                $model->financial_id = auth()->user()->financial_id;
