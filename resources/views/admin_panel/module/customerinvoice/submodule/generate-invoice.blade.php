...
@section('main-content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            alertify.set('notifier','position', 'top-right'); // 🔥 Set position to top-right
            let delay = 0;
            ...
            @foreach ($errors->all() as $error)
                ...
                delay += 500; // 0.5 second delay between messages
            @endforeach
        });
    </script>
@endif
    ...
    <form id="invoiceForm" action="{{ route('admin_panel.module.customerinvoice.saveInvoice') }}" method="POST">
        @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                        ...
                        <div class="col-sm-12">
                            <fieldset class="form-fieldset mx-3 mb-3">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <select id="customerSelect" name="customer_id" required class="form-control">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" name="invoice_number"
                                        id="invoiceNumber" placeholder="INV000X" readonly>
                                </div>
                ...
                <div class="col-sm-7 ms-auto me-3">
                    <div id="customerDetails" style="display: none;" class=" border rounded-3 p-3">
                        ...
                        <div class="details-grid p-3">
                            <p><i class="fas fa-user"></i> <strong>Contact Name:</strong> <span id="contactName"></span></p>
                            <p><i class="fas fa-building"></i> <strong>Organization:</strong> <span id="orgName"></span></p>
                            <p><i class="fas fa-envelope"></i> <strong>Email:</strong> <span id="email"></span></p>
                            <p><i class="fas fa-envelope-open-text"></i> <strong>Org Email:</strong> <span
                                    id="orgEmail"></span></p>
                            ...
                            <p><i class="fas fa-map-pin"></i> <strong>PIN Code:</strong> <span id="pinCode"></span></p>
                            <p><i class="fab fa-whatsapp"></i> <strong>WhatsApp Contact:</strong> <span
                                    id="wpContact"></span></p>
                        </div>
                    </div>
                </div>
                            ...
                            <fieldset class="form-fieldset mx-3 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <select class="form-control input-sm" required name="payment_terms" id="paymentTerms">
                                            <option value="">**Select Payment Term</option>
                                            <option value="due_end_month">Due End of the Month</option>
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <input type="date" class="form-control input-sm" name="due_date" id="dueDate"
                                            readonly>
                                    </div>
                                </div>
                            </fieldset>
                    ...
                    <fieldset class="form-fieldset mx-3 mb-3">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="invoiceItems">
                                <tr class="itemRow">
                                    <td><input type="text" class="form-control item-details" required placeholder="Item Details">
                                    </td>
                                    <td><input type="number" class="form-control quantity" required value="1" min="1"></td>
                        ...
                        <div class="container-fluid">
                            <div class="row ">
                                <div class="col-sm-4 p-0 ">
                                    <fieldset class="form-fieldset   mb-2">
                                        ...
                                        <div class="input-group d-inline-flex">
                                            <input type="number" id="globalDiscount" name="global_discount"
                                                class="form-control input-sm w-75" value="0" min="0">
                                            <select id="globalDiscountType" name="global_discount_type"
                                                class="form-select input-sm w-25">
                                ...
                                <div class="col-sm-2"> <button id="addMore" type="button" class="btn btn-primary mt-3">Add
                                        More Item</button></div>
                            </div>
                        </div>
                    ...
                    <div class="accordion " id="invoiceSummaryAccordion">
                        ...
                        <div class="accordion-item  ms-3 rounded-3 border border-1 border-info">
                            <h2 class="accordion-header">
                                <button class="accordion-button bg-info text-white" style="height: 40px;" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapseSummary" aria-expanded="true"
                                    aria-controls="collapseSummary">
                                    <strong><i class="fas fa-money-bill-wave"></i> Total Amount: ₹ <span id="totalAmount"
                                            class="text-light">0.00</span></strong>
                                </button>
                            </h2>

                            <!-- Accordion Body -->
                            <div id="collapseSummary" class="accordion-collapse collapse show"
                                data-bs-parent="#invoiceSummaryAccordion">
                                <div class="accordion-body bg-light">
                                    ...
                                    <p class="d-flex justify-content-between">
                                        <strong style="color: #ff5722;"><i class="fas fa-receipt"></i> Subtotal Payable
                                            Amount:</strong>
                                    ...
                                    <p class="d-flex justify-content-between">
                                        ...
                                        <textarea class="form-control input-sm w-50" name="invoice_remark"
                                            id="invoiceRemark" rows="3" placeholder="Enter any remarks here..."></textarea>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-4 ms-auto me-3">
                    <div class="d-flex justify-content-end mt-2">
                        ...
                        <div class="dropdown w-25">
                            <button class="btn btn-success dropdown-toggle w-100" type="button" id="saveOptions"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-save"></i> More Options
                            </button>
                            <ul class="dropdown-menu w-100" style="" aria-labelledby="saveOptions">
                                <li><button class="dropdown-item" id="savePrint"><i class="fas fa-print"></i> Save and
                                        Print</button></li>
                                <li><button class="dropdown-item" id="saveShare"><i class="fas fa-share-alt"></i> Save and
                                        Share</button></li>
                                <li><button class="dropdown-item" id="saveShareLater"><i class="fas fa-clock"></i> Save &
                                        Share Later</button></li>
                            </ul>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function calculateSummary() {
                let totalItems = document.querySelectorAll(".itemRow").length;
                let totalAmount = 0;
                let totalDiscount = 0;
                ...
                document.querySelectorAll(".itemRow").forEach(row => {
                    ...
                    if (discountType === "%") {
                        totalDiscount += (subtotal * discount) / 100; // Item-wise discount
                    } else {
                ...
                totalDiscount += appliedGlobalDiscount; // Adding global discount to total discount
                totalPayable -= appliedGlobalDiscount;

                // Updating Summary Fields
                document.getElementById("totalItems").textContent = totalItems;
                document.getElementById("totalDiscount").textContent = totalDiscount.toFixed(2); // Updated
            ...
            function addRow() {
                let newRow = document.querySelector(".itemRow").cloneNode(true);
                newRow.querySelectorAll("input").forEach(input => input.value = "");
                newRow.querySelector(".quantity").value = 1;
                newRow.querySelector(".rate").value = 0;
            ...
            document.getElementById("invoiceItems").addEventListener("input", function (event) {
                if (event.target.closest(".itemRow")) {
                    calculateAmount(event.target.closest(".itemRow"));
                }
            });
            ...
            // Trigger Calculation on Global Discount Change
...
<script>
    $(document).ready(function () {
        ...
        let selectedCustomerId = '{{ old("customer_id") }}'; // Laravel old() for pre-selection
        ...
        $.ajax({
            ...
            success: function (response) {
                console.log("Customer Data:", response); // Debugging log
                let options = '<option value="">Select Customer</option>';
                
                $.each(response, function (index, customer) {
                    let selected = (selectedCustomerId == customer.id) ? 'selected' : '';
                    options += `<option value="${customer.id}" ${selected}>
                                    ${customer.short_name} - ${customer.name} { ${customer.primary_contact_name} }
                                </option>`;
                ...
                // If a customer was previously selected, trigger the data load
                if (selectedCustomerId && customerData[selectedCustomerId]) {
                    showCustomerDetails(customerData[selectedCustomerId]);
                }
            },
        ...
        $('#customerSelect').on('change', function () {
            ...
            if (customerId && customerData[customerId]) {
                showCustomerDetails(customerData[customerId]);
            } else {
                $('#customerDetails').hide();
            }
        });

        // Reusable function to show customer details
    ...
    <script>
        ...
        function submitInvoiceForm(status) {
            let items = [];
            document.querySelectorAll('#invoiceItems .itemRow').forEach(row => {
                let item = {
                    details: row.querySelector('.item-details').value,
                    quantity: row.querySelector('.quantity').value,
                    rate: row.querySelector('.rate').value,
                    discount: row.querySelector('.discount').value,
                    discountType: row.querySelector('.discount-type').value,
