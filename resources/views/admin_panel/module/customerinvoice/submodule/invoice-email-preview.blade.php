...
@section('main-content')
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card " style="max-width: 650px; width: 100%; border-radius: 12px; overflow: hidden;">

            <!-- Card Header with Background & Icon -->
            <div class="card-header text-white text-center py-3 bg-info">
                <h4 class="mb-0 fw-bold text-light">
                    <img src="https://cdn-icons-png.flaticon.com/512/281/281769.png" style="height:20px"> Review & Send Your
                    Invoice Email
                </h4>
            </div>
            ...
            <div class="card-body p-4">
                <hr>
                <form action="{{ route('invoice.sendEmail', $id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="invoice_number" value="{{ $invoice->invoice_number }}">

                    <fieldset class="border p-3 rounded">
                        <legend class="float-none w-auto px-3 text-success fw-bold">
                            <small style="color:#00B8D4;font-size:17px"><i class="fas fa-paper-plane"></i> Email
                                Details</small>
                        </legend>

                        <!-- Recipient Email -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color:#00B8D4"><i class="fas fa-user"></i> To :</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                <input type="email" name="to_email" required
                                    value="{{ $invoice->customer->email_address ?? '' }}" required class="form-control"
                        ...
                        <!-- Subject -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color:#00B8D4"><i class="fas fa-edit"></i>
                                Subject:</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-comment-alt"></i></span>
                                <input type="text" name="subject" required
                                    value="From Digivity Technology Pvt. Ltd. {Invoice #{{ $invoice->invoice_number }}}"
                        ...
                        <!-- Message -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color:#00B8D4"><i class="fas fa-comment-dots"></i>
                                Header Message:</label>
                            <textarea name="message" rows="5" required class="form-control"
                                style="resize: none; border-radius: 8px;">We hope this email finds you well. Please find attached your invoice for the services provided by Digivity Technology.
                    ...
                    <div class="d-grid mt-3">
                        <button type="submit" class="btn btn-info fw-bold w-25 text-light mx-auto">
