...
@section('ModelTitleInfo','Manage Customers')
@section('EditModelTitle','Edit Customer')
@section('EditModelTitleInfo','Manage Customers')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-style1 mg-b-10">
        ...
        <li class="breadcrumb-item active" aria-current="page">Billing System</li>
...
<div class="custom-card col-lg-12 mx-auto">
    <div class="panel panel-default">
        ...
        <div class="panel-body pd-b-0 row">
            <div class="col-lg-2">
            @include('admin_panel.layouts.actionbutton.CustomersActionButton')
            </div>
            ...
            <table id="example2" class="table datatable table-bordered dataTable example2" >
                    <thead class="bg-light fw-bold">
                        <tr class="py-3">
                            ...
                            <th class="fw-bold">Gmail</th>
                            <th class="fw-bold">Commission-Based Client</th>
                            <th class="fw-bold">Referred By</th>
                    ...
                    <tbody>
                        ...
                        <tr editurl="" deleteurl="{{ route('RecordDelete', ['id' => $customer->id, 'table_name' => 'billing_customer_table']) }}">
                            ...
                            <td class="text-center">{!! $customer->is_commision_based_client == 'yes' ? '<span class="badge text-bg-success">Yes</span>
                                ' : '<span class="badge text-bg-danger">No</span>'
                                !!}</td>
                             <td>{{ $customer->referred_by_name ?? '_' }}</td>  
                             <td>{{ $customer->persentage_commission }}</td> 
                            <td class="text-center">{!! $customer->is_active == 'yes' ? '<span class="badge text-bg-success">Active</span>
