<a href="{{ route('admin_panel.module.load-generate-invoice')}}"><button  type="button"   class="btn btn-block mg-t-10 btn-outline-primary btn-sm rounded-pill w-100"><i class="fa fa-plus"></i> Add New</button></a>
