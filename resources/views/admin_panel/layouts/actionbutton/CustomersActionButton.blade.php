<button  type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenterCustomer"  class="btn btn-block mg-t-10 btn-outline-primary btn-sm rounded-pill w-100"><i class="fa fa-plus"></i> Add New</button>
